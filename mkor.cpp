...
#pragma config(Sensor, S2,     color2,         sensorEV3_Color, modeEV3Color_Color)
#pragma config(Sensor, S3,     heightT,        sensorEV3_Touch)
#pragma config(Sensor, S4,     widthT,         sensorEV3_Touch)
#pragma config(Motor,  motorA,          width,         tmotorEV3_Medium, PIDControl, encoder)
#pragma config(Motor,  motorB,          height,        tmotorEV3_Large, PIDControl, encoder)
#pragma config(Motor,  motorC,          hand,          tmotorEV3_Medium, PIDControl, encoder)
